<?php
/*
Template Name: Blog: Date in Title
*/
?>
<?php get_header(); ?>
<?php
...
if(isset($qode_options['blog_date_in_title_content_position'])){
	$blog_content_position = $qode_options['blog_date_in_title_content_position'];
}
...
if(isset($qode_options['blog_date_in_title_number_of_chars']) && $qode_options['blog_date_in_title_number_of_chars'] != "") {
    qode_set_blog_word_count(esc_attr($qode_options['blog_date_in_title_number_of_chars']));
}
...
?>
    ...
    <div class="container"<?php if($background_color != "") { echo " style='background-color:". $background_color ."'";} ?>>
        <div class="container_inner default_template_holder" <?php if($content_style != "") { echo $content_style; /* dynamically generated style attr. Note that is escaped on line 37-40 */ } ?>>
            <?php if(($sidebar == "default")||($sidebar == "")) : ?>
                <?php
                echo apply_filters( 'the_content', $q_content );
