...
if (isset($qode_options['blog_category_title_first_centered_show_categories'])){
	$blog_show_categories = $qode_options['blog_category_title_first_centered_show_categories'];
}

$blog_show_comments = "yes";
if (isset($qode_options['blog_category_title_first_centered_show_comments'])){
    $blog_show_comments = $qode_options['blog_category_title_first_centered_show_comments'];
}
$blog_show_author = "yes";
if (isset($qode_options['blog_category_title_first_centered_show_author'])){
    $blog_show_author = $qode_options['blog_category_title_first_centered_show_author'];
}
$blog_show_like = "no";
if (isset($qode_options['blog_category_title_first_centered_like'])) {
    $blog_show_like = $qode_options['blog_category_title_first_centered_like'];
}
$blog_show_ql_icon_mark = "yes";
if (isset($qode_options['blog_category_title_first_centered_show_ql_mark'])) {
    $blog_show_ql_icon_mark = $qode_options['blog_category_title_first_centered_show_ql_mark'];
}

$blog_show_date = "yes";
if (isset($qode_options['blog_category_title_first_centered_show_date'])) {
    $blog_show_date = $qode_options['blog_category_title_first_centered_show_date'];
}

$blog_social_share_type = "dropdown";
if(isset($qode_options['blog_category_title_first_centered_select_share_option'])){
	$blog_social_share_type = $qode_options['blog_category_title_first_centered_select_share_option'];
}
...
if (isset($qode_options['enable_social_share'])&& ($qode_options['enable_social_share']) =="yes"){
    if (isset($qode_options['post_types_names_post'])&& $qode_options['post_types_names_post'] =="post"){
        if (isset($qode_options['blog_category_title_first_centered_show_share']) && $blog_social_share_type == "dropdown" ) {
            $blog_show_social_share = $qode_options['blog_category_title_first_centered_show_share'];
        }
    }
}
			...
			<div class="post_content_holder">
				...
				<div class="post_text">
					<div class="post_text_inner">
						<?php
							qode_excerpt();
							qode_read_more_button('blog_category_title_first_centered_read_more_button', 'post_info_item');
						?>
						...
						<?php } ?>	
						<?php if(isset($qode_options['blog_category_title_first_centered_show_share']) && $qode_options['blog_category_title_first_centered_show_share'] == "yes" && $blog_social_share_type == "list") {
				...
				<div class="post_text  <?php if($blog_ql_background_image == "yes"){ if ( has_post_thumbnail() ) { ?> link_image" style="background-image: url(<?php echo esc_url($background_image_src); ?>); <?php }} ?>">
                    <div class="post_text_inner">
						...
						<?php if($blog_show_date == "yes" || $blog_show_social_share == "yes" || $blog_show_comments == "yes" || $blog_show_like == "yes" || $blog_show_categories == "yes" || $blog_show_author == "yes") { ?>	
							<div class="post_info post_info_item">
								<?php qode_post_info(array('author' => $blog_show_author , 'date' => $blog_show_date, 'category' => $blog_show_categories, 'comments' => $blog_show_comments, 'like' => $blog_show_like));
								if($blog_social_share_type == "dropdown"){
									qode_post_info(array('share' => $blog_show_social_share));			
								} ?>
							</div>
