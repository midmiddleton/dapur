...
if (isset($qode_options['blog_date_in_title_show_categories'])){
	$blog_show_categories = $qode_options['blog_date_in_title_show_categories'];
}

$blog_show_comments = "yes";
if (isset($qode_options['blog_date_in_title_show_comments'])){
	$blog_show_comments = $qode_options['blog_date_in_title_show_comments'];
}
$blog_show_author = "yes";
if (isset($qode_options['blog_date_in_title_show_author'])){
	$blog_show_author = $qode_options['blog_date_in_title_show_author'];
}
$blog_show_like = "no";
if (isset($qode_options['blog_date_in_title_show_like'])) {
	$blog_show_like = $qode_options['blog_date_in_title_show_like'];
}
$blog_show_ql_icon_mark = "yes";
$blog_title_holder_icon_class = "";
if (isset($qode_options['blog_date_in_title_show_ql_mark'])) {
	$blog_show_ql_icon_mark = $qode_options['blog_date_in_title_show_ql_mark'];
}
...
$blog_show_date = "yes";
if (isset($qode_options['blog_date_in_title_show_date'])) {
	$blog_show_date = $qode_options['blog_date_in_title_show_date'];
}
$blog_show_social_share = "no";
$blog_social_share_type = "dropdown";
if(isset($qode_options['blog_date_in_title_select_share_option'])){
	$blog_social_share_type = $qode_options['blog_date_in_title_select_share_option'];
}
if (isset($qode_options['enable_social_share'])&& $qode_options['enable_social_share'] =="yes"){
	if (isset($qode_options['post_types_names_post'])&& $qode_options['post_types_names_post'] =="post"){
		if (isset($qode_options['blog_date_in_title_show_share']) && $blog_social_share_type == "dropdown") {
			$blog_show_social_share = $qode_options['blog_date_in_title_show_share'];
		}
	}
}

$blog_ql_background_image = "no";
if(isset($qode_options['blog_date_in_title_ql_background_image'])){
	$blog_ql_background_image = $qode_options['blog_date_in_title_ql_background_image'];
}
			...
			<div class="post_content_holder">
				...
				<div class="post_text">
					<div class="post_text_inner">
						...
						<?php
							qode_excerpt();
							qode_read_more_button('blog_date_in_title_read_more_button');
						?>
						<?php if($blog_show_author == "yes" || $blog_show_social_share == "yes" || $blog_show_categories == "yes" || $blog_show_comments == "yes" || $blog_show_like == "yes") { ?>	
							<div class="post_info">
								<?php qode_post_info(array('author' => $blog_show_author, 'share' => $blog_show_social_share, 'category' => $blog_show_categories, 'comments' => $blog_show_comments, 'like' => $blog_show_like)); ?>
							</div>
						<?php } ?>						
						<?php if(isset($qode_options['blog_date_in_title_show_share']) && $qode_options['blog_date_in_title_show_share'] == "yes" && $blog_social_share_type == "list") {
				...
				<div class="post_text">
					<div class="post_text_inner">
						...
						<?php
							...
							qode_read_more_button('blog_date_in_title_read_more_button');
						?>
						<?php if(isset($qode_options['blog_date_in_title_show_share']) && $blog_show_author == "yes" || $blog_show_social_share == "yes" || $blog_show_categories == "yes" || $blog_show_comments == "yes" || $blog_show_like == "yes") { ?>	
							<div class="post_info">
								<?php qode_post_info(array('author' => $blog_show_author, 'share' => $blog_show_social_share, 'category' => $blog_show_categories, 'comments' => $blog_show_comments, 'like' => $blog_show_like)); ?>
							</div>
						<?php } ?>						
						<?php if($qode_options['blog_date_in_title_show_share'] == "yes" && $blog_social_share_type == "list") {
							echo do_shortcode('[no_social_share_list]');
						}; ?>
					</div>
				</div>
