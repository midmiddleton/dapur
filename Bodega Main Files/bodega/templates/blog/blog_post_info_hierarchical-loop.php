...
if (isset($qode_options['blog_post_info_hierarchical_show_categories'])){
	$blog_show_categories = $qode_options['blog_post_info_hierarchical_show_categories'];
}

$blog_show_comments = "no";
if (isset($qode_options['blog_post_info_hierarchical_show_comments'])){
    $blog_show_comments = $qode_options['blog_post_info_hierarchical_show_comments'];
}
$blog_show_author = "no";
if (isset($qode_options['blog_post_info_hierarchical_show_author'])){
    $blog_show_author = $qode_options['blog_post_info_hierarchical_show_author'];
}
$blog_show_like = "no";
if (isset($qode_options['blog_post_info_hierarchical_show_like'])) {
    $blog_show_like = $qode_options['blog_post_info_hierarchical_show_like'];
}

$blog_show_date = "no";
if (isset($qode_options['blog_post_info_hierarchical_show_date'])) {
    $blog_show_date = $qode_options['blog_post_info_hierarchical_show_date'];
}


$blog_show_social_share = "no";
$blog_social_share_type = "dropdown";
if(isset($qode_options['blog_post_info_hierarchical_select_share_option'])){
	$blog_social_share_type = $qode_options['blog_post_info_hierarchical_select_share_option'];
}
if (isset($qode_options['enable_social_share'])&& ($qode_options['enable_social_share']) =="yes"){
    if (isset($qode_options['post_types_names_post'])&& $qode_options['post_types_names_post'] =="post"){
        if (isset($qode_options['blog_post_info_hierarchical_show_share'])&& $blog_social_share_type == "dropdown" ) {
            $blog_show_social_share = $qode_options['blog_post_info_hierarchical_show_share'];
        }
    }
}

$blog_show_ql_icon_mark = "yes";
if (isset($qode_options['blog_post_info_hierarchical_show_ql_mark'])) {
	$blog_show_ql_icon_mark = $qode_options['blog_post_info_hierarchical_show_ql_mark'];	
}

$blog_ql_background_image = "no";
if(isset($qode_options['blog_post_info_hierarchical_ql_background_image'])){
	$blog_ql_background_image = $qode_options['blog_post_info_hierarchical_ql_background_image'];
}
					...
					<div class="post_text_inner">
						<?php if ($blog_show_date == "yes") { ?>
							<div class="post_info post_date">
								<?php qode_post_info(array('date' => $blog_show_date)); ?>
							</div>
						<?php } ?>
                        <h2>
						...
						<?php
                            qode_excerpt();
							qode_read_more_button('blog_post_info_hierarchical_read_more_button');
						?>
						...
						<?php if ($blog_show_comments == "yes") { ?>
							<div class="post_info post_comments">
								 <?php qode_post_info(array('comments' => $blog_show_comments)); ?>
							</div>
						<?php } ?>
						<?php if (isset($qode_options['blog_post_info_hierarchical_show_share']) && $qode_options['blog_post_info_hierarchical_show_share'] == "yes") { 
							if($blog_social_share_type == "dropdown"){ ?>
								<div class="post_info post_share">
									<?php
										qode_post_info(array('share' => $blog_show_social_share));
									?>
								</div>
							<?php } if($blog_social_share_type == "list") {						
								echo do_shortcode('[no_social_share_list]');
						}} ?>
						<?php if ($blog_show_like == "yes") { ?>
							<div class="post_info post_likes">
								<?php
									qode_post_info(array('like' => $blog_show_like));
								?>							
							</div>
						<?php } ?>		
			...
			<div class="post_content_holder">
				<div class="post_text  <?php if($blog_ql_background_image == "yes") {if ( has_post_thumbnail() ) { ?> link_image" style="background:url(<?php echo esc_url($background_image_src); ?>); <?php } } ?>">
					<div class="post_text_inner">						
						...
						<?php } ?>	
						<?php if (isset($qode_options['blog_post_info_hierarchical_show_share']) && $qode_options['blog_title_author_centered_show_share'] == "yes" && $blog_social_share_type == "list") { 
							echo do_shortcode('[no_social_share_list]');
						}?>
                    </div>
				</div>
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				<div class="post_content_holder">
					...
					<div class="post_text_inner">
						...
						<?php } ?>
						<?php if (isset($qode_options['blog_post_info_hierarchical_show_share']) && $qode_options['blog_post_info_hierarchical_show_share'] == "yes" && $blog_social_share_type == "list") { 
							echo do_shortcode('[no_social_share_list]');
						}?>
						</div>
					</div>
