...
switch ($_post_format) {
				...
				<div class="post_text">
					<div class="post_text_inner">
						...
						<?php if($blog_show_author == "yes" || $blog_show_social_share == "yes" || $blog_show_categories == "yes" || $blog_show_comments == "yes" || $blog_show_like == "yes") { ?>	
							<div class="post_info">
								<?php qode_post_info(array('author' => $blog_show_author, 'category' => $blog_show_categories, 'comments' => $blog_show_comments, 'like' => $blog_show_like));
	...
	case "link":
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<div class="post_content_holder">
				<div class="post_text<?php echo $background_image_html_class; ?>" <?php echo $background_image_html; /* dynamically generated style attr. Note that is escaped on line 65 */ ?>>
					<div class="post_text_inner">
						...
						<div class="post_title<?php echo esc_attr($blog_title_holder_icon_class); ?>">
							<h3>
								...
								<a href="<?php echo esc_url($title_link); ?>"><?php the_title(); ?></a>
							</h3>
						</div>
						<?php if($blog_show_author == "yes" || $blog_show_social_share == "yes" || $blog_show_categories == "yes" || $blog_show_comments == "yes" || $blog_show_like == "yes") { ?>	
							<div class="post_info">
