...
if(is_array($portfolio_categories) && count($portfolio_categories) && $portfolio_hide_categories != "yes"){
	...
	<div class="info portfolio_single_categories">
		<<?php echo esc_attr($portfolio_info_tag); ?> class="info_section_title" <?php echo $portfolio_info_style; /* dynamically generated style attr. Note that is escaped on line 16-26 */ ?>><?php _e('Category ','qode'); ?></<?php echo esc_attr($portfolio_info_tag); ?>>
		<p>
			<span class="category">
