<?php
/*
Template Name: Blog: Post Info Hierarchical
*/
?>
<?php get_header(); ?>
<?php
...
if(isset($qode_options['blog_post_info_hierarchical_content_position'])){
	$blog_content_position = $qode_options['blog_post_info_hierarchical_content_position'];
}
...
if(isset($qode_options['blog_post_info_hierarchical_number_of_chars']) && $qode_options['blog_post_info_hierarchical_number_of_chars']) {
    qode_set_blog_word_count(esc_attr($qode_options['blog_post_info_hierarchical_number_of_chars']));
}
...
?>
    ...
    <div class="container"<?php if($background_color != "") { echo " style='background-color:". $background_color .";'";} ?>>
        <div class="container_inner default_template_holder" <?php if($content_style != "") { echo $content_style; /* dynamically generated style attr. Note that is escaped on line 38-40 */ } ?>>
