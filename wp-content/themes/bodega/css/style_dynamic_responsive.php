...
@media only screen and (min-width: 600px) and (max-width: 768px){
	<?php if(isset($qode_options['h1_fontsize']) && ($qode_options['h1_fontsize'])>40) { ?>
		.title h1{
			font-size:<?php echo esc_attr($qode_options['h1_fontsize'])*0.7; ?>px;
		}
	<?php } ?>
	<?php if(isset($qode_options['page_title_fontsize']) && ($qode_options['page_title_fontsize'])>40) { ?>
		.title h1{
			font-size:<?php echo esc_attr($qode_options['page_title_fontsize'])*0.7; ?>px;
		}
	<?php } ?>
	<?php if(isset($qode_options['h2_fontsize']) && ($qode_options['h2_fontsize'])>40) { ?>
		.content h2{
			font-size:<?php echo esc_attr($qode_options['h2_fontsize'])*0.7; ?>px;
		}
	<?php } ?>
	<?php if(isset($qode_options['h3_fontsize']) && ($qode_options['h3_fontsize'])>40) { ?>
		.content h3{
			font-size:<?php echo esc_attr($qode_options['h3_fontsize'])*0.7; ?>px;
		}
	<?php } ?>
	<?php if(isset($qode_options['h4_fontsize']) && ($qode_options['h4_fontsize'])>40) { ?>
		.content h4{
			font-size:<?php echo esc_attr($qode_options['h4_fontsize'])*0.7; ?>px;
		}
	<?php } ?>
	<?php if(isset($qode_options['h5_fontsize']) && ($qode_options['h5_fontsize'])>40) { ?>
		.content h5{
			font-size:<?php echo esc_attr($qode_options['h5_fontsize'])*0.7; ?>px;
		}
	<?php } ?>
	<?php if(isset($qode_options['h6_fontsize']) && ($qode_options['h6_fontsize'])>40) { ?>
		.content h6{
...
@media only screen and (max-width: 600px){
	<?php if(isset($qode_options['h1_fontsize']) && ($qode_options['h1_fontsize'])>40) { ?>
			.title h1{
				font-size:<?php echo esc_attr($qode_options['h1_fontsize'])*0.5; ?>px;
			}
	<?php } ?>
	<?php if(isset($qode_options['page_title_fontsize']) && ($qode_options['page_title_fontsize'])>40) { ?>
		.title h1{
			font-size:<?php echo esc_attr($qode_options['page_title_fontsize'])*0.5; ?>px;
		}
	<?php } ?>
	<?php if(isset($qode_options['h2_fontsize']) && ($qode_options['h2_fontsize'])>40) { ?>
			.content h2{
				font-size:<?php echo esc_attr($qode_options['h2_fontsize'])*0.5; ?>px;
			}
	<?php } ?>
	<?php if(isset($qode_options['h3_fontsize']) && ($qode_options['h3_fontsize'])>40) { ?>
		.content h3{
			font-size:<?php echo esc_attr($qode_options['h3_fontsize'])*0.5; ?>px;
		}
	<?php } ?>
	<?php if(isset($qode_options['h4_fontsize']) && ($qode_options['h4_fontsize'])>40) { ?>
		.content h4{
