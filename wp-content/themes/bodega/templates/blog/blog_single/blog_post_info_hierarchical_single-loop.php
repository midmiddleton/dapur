			...
			<div class="post_content_holder">
				...
				<div class="post_text">
					<div class="post_text_inner">
						...
						<?php } ?>
						<?php if (isset($qode_options['blog_single_show_social_share']) && $qode_options['blog_single_show_social_share'] == "yes") { 
				...
				<div class="post_text">
					<div class="post_text_inner">
						...
						<?php if (isset($qode_options['blog_single_show_social_share']) && $qode_options['blog_single_show_social_share'] == "yes") { 
							if($blog_social_share_type == "dropdown"){ ?>
								<div class="post_info post_share">
									<?php qode_post_info(array('share' => $blog_show_social_share)); ?>
								</div>
							<?php } if($blog_social_share_type == "list") {						
								echo do_shortcode('[no_social_share_list]');
							}} ?>
...
?>
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<div class="post_content_holder">
				<div class="post_text<?php echo $background_image_html_class; ?>" <?php echo $background_image_html; /* dynamically generated style attr. Note that is escaped on line 60 */ ?>>
					<div class="post_text_inner">						
