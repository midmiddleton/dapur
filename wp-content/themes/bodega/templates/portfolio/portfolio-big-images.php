...
<div class="portfolio_images">
    ...
    if ($portfolio_m_images){
        ...
        foreach($portfolio_image_gallery_array as $gimg_id){
            $title = esc_attr(get_the_title($gimg_id));
            $alt = esc_attr(get_post_meta($gimg_id, '_wp_attachment_image_alt', true));
	...
	<div class="column1">
		<div class="column_inner">
			<div class="portfolio_single_text_holder">
				<<?php echo esc_attr($portfolio_title_tag); ?> class="portfolio_single_text_title" <?php echo $portfolio_title_style; /* dynamically generated style attr. Note that is escaped on line 35-45 */ ?>><span><?php the_title(); ?></span></<?php echo esc_attr($portfolio_title_tag); ?>>
				<?php the_content(); ?>
			</div>
		</div>
	</div>
