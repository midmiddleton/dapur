	...
	<div class="column1">
		<div class="column_inner">
			<div class="portfolio_single_text_holder">
				<<?php echo $portfolio_title_tag; ?> class="portfolio_single_text_title" <?php echo $portfolio_title_style; /* dynamically generated style attr. Note that is escaped on line 28-38 */ ?>><span><?php the_title(); ?></span></<?php echo $portfolio_title_tag; ?>>
				<?php the_content(); ?>
			</div>
		</div>
	</div>
